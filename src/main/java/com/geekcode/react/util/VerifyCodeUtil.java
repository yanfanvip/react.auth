...
public class VerifyCodeUtil {
	...
	final static String randomCarts = "acdefghkmnprstuvwxyzACDEFGHGKLMNPQRSTUVWXYZ023456789";
    ...
    public static String imageToBase64(int w, int h, String code) throws Exception {
        ByteArrayOutputStream baos = image(w, h, code);
     ...
     * @throws Exception 
     */
    public static ByteArrayOutputStream image(int w, int h, String code) throws Exception {
     ...
     * @throws IOException 
     */  
    public static void write(OutputStream write, String base64) throws IOException {  
