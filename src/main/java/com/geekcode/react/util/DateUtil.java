...
public class DateUtil {
	...
	public static Calendar getYestday(){
		...
		yestday.set(Calendar.HOUR_OF_DAY, -24);
		return yestday;
	}
	/**
	 * 判断是否是同一天
	 */
	public static boolean theSameDay(Calendar c1, Date date2){
		if(c1 == null || date2 == null){ return false; }
	...
	public static boolean isYestday(Date date){
		...
		return calendar.get(Calendar.YEAR) == yestday.get(Calendar.YEAR) && calendar.get(Calendar.DAY_OF_YEAR) == yestday.get(Calendar.DAY_OF_YEAR);
	}
    /** 
     * 获取SimpleDateFormat 
     * @param pattern 日期格式 
